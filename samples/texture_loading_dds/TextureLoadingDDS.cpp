...
{
  public:
    TextureLoadingDDSSample::TextureLoadingDDSSample()
        : SampleApplication("TextureLoadingDDS", 720, 720)
    {
    }
    ...
    virtual bool initialize()
    {
        ...
        // Load the texture
        std::string path = std::string(angle::GetExecutableDirectory()) + "\\bc3compressed.dds";
